...
class InputOutputDataset(Dataset):
    ...
    def __getitem__(self, i) -> dict:
        ...
        a_ids = self.tokenizer.encode(text=data_item['answer'], add_special_tokens=True, truncation=True,
                                         max_length=self.max_source_length)
        b_ids = self.tokenizer.encode(text=data_item['question'], add_special_tokens=False, truncation=True,
